...
<html lang='en'>
    <head>
        ...
        <meta property='og:image:url' content='<?php echo $config['baseURL']?>/resources/images/share/linkPreview/facebookTest5.png' />
        <meta property='og:image' content='<?php echo $config['baseURL']?>/resources/images/share/linkPreview/facebookTest5.png' />
    </head>
    <body ontouchstart=''>
        <div id='about'>
